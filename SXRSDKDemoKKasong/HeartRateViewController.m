...
-(void)viewWillAppear:(BOOL)animated{
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onReadData:) name:notify_key_kkasong_did_recv_sensor_report object:nil];
}
...
-(void)onReadData:(NSNotification*)notify{
    ...
    int sensorvalue = [[param objectForKey:KKASONG_NOTIFY_PARAM_SENSORVALUE] intValue];
    int sensortype = [[param objectForKey:KKASONG_NOTIFY_PARAM_SENSORTYPE] intValue];
